					...
					<form>
						...
						<div class="s-listpo">
							...
							<div class="button-area s-listpo ">
								<img alt="가게로고"
									src="${pageContext.request.contextPath}/assets/imges/aaa.jpeg"
								>
								<div class="addBtn">
									<input type="file">
								</div>
						...
						<div class="content">
							...
							<div class="s-listpo">
								...
								<p>
									...
									<input type="radio" id="rdo-parking" name="parking"
										value="yesP" checked="checked"
									>

									<label for="rdo-noParking">주차 불가능</label>
									<input type="radio" id="rdo-noParking" name="parking"
										value="noP"
									>
							</div>
