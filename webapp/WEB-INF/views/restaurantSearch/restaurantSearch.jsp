...
<body>
	<div class="map_wrap">
		...
		<div id="typeCheck">
			<input type="checkbox"><span>비건</span>
			<input type="checkbox"><span>락토</span>
			<input type="checkbox"><span>오보</span>
			<input type="checkbox"><span>락토오보</span>
			<input type="checkbox"><span>페스코</span>
		</div>
